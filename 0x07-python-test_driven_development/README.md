...
![alt text](https://s3.amazonaws.com/intranet-projects-files/AlxAfricaschool-higher-level_programming+/246/giphy-4.gif)

In this project, I started practicing test-driven development using `docstring`and `unittest` in Python.

## Tests :heavy_check_mark:

* [tests](./tests): Folder of test files. Includes both AlxAfrica-provided ones as well as the following eight independently-developed:
